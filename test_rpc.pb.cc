...
static ::_pb::Metadata file_level_metadata_test_5frpc_2eproto[4];
...
const uint32_t TableStruct_test_5frpc_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::testrpc::Operator, _impl_.result_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 16, -1, -1, sizeof(::testrpc::SummNote)},
  { 24, -1, -1, sizeof(::testrpc::OperatorsSummary)},
};
...
const char descriptor_table_protodef_test_5frpc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "or\022\014\n\004name\030\001 \001(\t\022\"\n\006result\030\002 \001(\0132\022.testr"
  "pc.Variables\"F\n\010SummNote\022)\n\rtype_operato"
  "r\030\001 \001(\0132\022.testrpc.Variables\022\017\n\007message\030\002"
  " \001(\t\"X\n\020OperatorsSummary\022\027\n\017variables_co"
  "unt\030\001 \001(\005\022\025\n\rfeature_count\030\002 \001(\005\022\024\n\014elap"
  "sed_time\030\003 \001(\0052\272\001\n\010TestgRPC\0223\n\010get_summ\022"
  "\022.testrpc.Variables\032\021.testrpc.Operator\"\000"
  "\022@\n\013record_summ\022\022.testrpc.Variables\032\031.te"
  "strpc.OperatorsSummary\"\000(\001\0227\n\tsumm_chat\022"
  "\021.testrpc.SummNote\032\021.testrpc.SummNote\"\000("
  "\0010\001b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_test_5frpc_2eproto = {
    false, false, 491, descriptor_table_protodef_test_5frpc_2eproto,
    "test_rpc.proto",
    &descriptor_table_test_5frpc_2eproto_once, nullptr, 0, 4,
...
class Operator::_Internal {
 public:
  static const ::testrpc::Variables& result(const Operator* msg);
};

const ::testrpc::Variables&
Operator::_Internal::result(const Operator* msg) {
...
Operator::Operator(const Operator& from)
  ...
  if (from._internal_has_result()) {
    _this->_impl_.result_ = new ::testrpc::Variables(*from._impl_.result_);
  }
...
void Operator::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_result()) {
    _this->_internal_mutable_result()->::testrpc::Variables::MergeFrom(
